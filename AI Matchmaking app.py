...
def load_movies():
    ...
    try:
        ...
        return pd.DataFrame({
            "Series_Title": ["The Godfather", "The Dark Knight"],
            "Genre": ["Action", "Comedy"],
            "Director": ["Director A", "Director B"],
            "Overview": ["The Godfather", "The Dark Knight"],
            "IMDB_Rating": [7.5, 8.0],
            "Poster_Link": [POSTER_PLACEHOLDER, POSTER_PLACEHOLDER],
            "Runtime": [120, 90],
            "combined_features": ["Action Director A The Godfather", "Comedy Director B The Dark Knight"]
        })
